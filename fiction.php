...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <li class="dropdown-menu">
    <a id= "active" aria-current="page" target="blank" class="dropdown-item"  href="fiction.php">Fiction</a>
  ...
  <section class ="my-10">
      <div>
        <h2 class ="text-center" style="background: #405D9d;color:white">Fiction</h2>
        <frameborder="0" scrolling="no" style="border:0px" src="C:/xampp/htdocs/Books4U/pdf_books/sciencefiction.pdf" width=500 height=500></frameborder=>
