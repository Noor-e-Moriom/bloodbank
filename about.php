...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto ">
        ...
        <li class="nav-item">
          <a id="active" class="nav-link active" aria-current="page"  href="about.php" target="blank">About</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="register.php" target="blank">Contact & feedback</a>
        </li>
        <li class="nav-item">
  ...
  <section class ="my-5">
  <div class="py-5">
    <h2 class =text-center>About Books4U</h2>
  </div>
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-12">
      <iframe width="500" height="325" src="https://www.youtube.com/embed/JveHM_wsJxQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
      <div class="col-lg-6 col-md-6 col-12">
        <h4 class="h4">Reading fiction can help you be more open-minded and creative</h4>
        <p>To learn something we need to 
       ...
       <a class="btn btn-success" href="about.php">read more</a>
...
<section class ="my-5">
  ...
  <div class="container-fluid">
        <div class="row">
                <div class="col-lg-4 col-md-4 col-12">
                      ...
                      <img class="card-img-top" src="img/pdf1.jpg" alt="books image">
                      <div class="card-body">
                      <h4 class="card-title">Moon-split</h4>
  ...
  <section class ="my-5">
      ...
      <div class="container-fluid">
         <div class="row">
           <div class="col-lg-4 col-md-4 col-12">
             <img src="img/pdf2.jpg" class="img-fluid pb-4">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
             <img src="img/pdf3.jpg" class="img-fluid pb-4">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
             <img src="img/fiction.jpg" class="img-fluid pb-4">
            </div>
            <div class="col-lg-4 col-md-4 col-12">
             <img src="img/fiction.jpg" class="img-fluid pb-4">
            </div>
  ...
  <div class="form-group">
    ...
    <div class="form-group form-check">
      <label class="form-check-label">
        <input class="form-check-input" type="checkbox" name="remember"  autocomplete="off"> Remember me
      </label>
    </div>
